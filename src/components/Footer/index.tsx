...
export function Footer() {
  return (
    <footer className="ml-14">
      <div className="flex flex-col bg-primary-gray bg-opacity-30 backdrop-blur-sm">
        <FunctionStyle label="<footer>" />
        ...
        <FunctionStyle label="</footer>" classname="ml-auto mr-0" />
      </div>
      <FunctionStyle label="</html>" />
    </footer>
  );
}
